...
What to look for, per category. Read the relevant section plus the **Finding format** at the bottom before auditing. Adapt depth to repo size — a 2K-line CLI gets a lighter pass than a 500K-line monorepo.
